package com.dobuki.yahooks
{
		...
		implements IEventDispatcher
	{
		...
		static public function get instance():Yahooks {
			return _instance;
		}
		...
		private function handleJoin(connection:Connection):void{
			...
			connection.addMessageHandler("playerLeft",function(m:Message,playerName:String,count:int):void {
				for each (var hookInfo:HookInfo in _hookInfo) {
					if(hookInfo.leaveFunction!=null) {
						hookInfo.leaveFunction.call(hookInfo.hook,playerName,count);
					}
				}
			});
